...
public interface ViewInterface {
     ...
     *             If width < 4 or width > 20 or height < 4 or height > 20
     */
     ...
     * 
     * @param moves
     *            A list of all tiles to be moved; includes their past and present positions and values.
     */
     ...
     * 
     * @param newTiles
     *            A list of all tiles to be added to the board; includes their positions and values.
     */
